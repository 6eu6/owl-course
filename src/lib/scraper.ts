...
const CATEGORY_MAP: Record<string, string[]> = {
  ...
  'Data Science & AI': ['data science', 'machine learning', 'deep learning', 'ai', 'artificial intelligence', 'nlp', 'neural', 'tensorflow', 'pytorch', 'chatgpt', 'gpt', 'llm', 'data analysis', 'data analytics', 'computer vision', 'opencv', 'ml', 'spark', 'apache spark', 'statistics', 'statistical', 'probability', 'regression', 'correlation', 'hypothesis', 'confidence interval', 'sampling', 'central limit', 'standard error', 'bell curve', 'predictive'],
  'Python': ['python', 'django', 'flask', 'pandas', 'numpy', 'matplotlib', 'scipy', 'python 3', 'tkinter'],
  'Cloud & DevOps': ['cloud', 'aws', 'azure', 'gcp', 'docker', 'kubernetes', 'devops', 'terraform', 'ci/cd', 'linux', 'vmware', 'jenkins', 'ansible', 'openshift', 'red hat', 'redhat', 'rhca', 'hashicorp', 'consul', 'vault', 'prometheus', 'grafana', 'helm', 'istio', 'observability'],
  'Cybersecurity': ['security', 'cybersecurity', 'ethical hacking', 'penetration', 'network security', 'infosec', 'ceh', 'hacking', 'cyber', 'bug bounty', ' kali linux', 'gdpr', 'data privacy', 'data protection', 'cipp', 'iapp', 'iso 27001', 'soc 2', 'pci dss'],
  ...
  'Business': ['business', 'management', 'project management', 'entrepreneurship', 'finance', 'accounting', 'excel', 'startup', 'agile', 'scrum', 'product management', 'leadership', 'hr', 'human resources', 'six sigma', 'lean', 'black belt', 'green belt', 'yellow belt', 'white belt', 'pmp', 'capm', 'prince2', 'osha', 'recruiting', 'recruitment', 'hiring', 'talent', 'workforce', 'attrition', 'retention', 'employee engagement', 'diversity', 'inclusion', 'dei', 'l&d', 'sales', 'selling', 'negotiation', 'procurement', 'supply chain', 'quality management', 'iso 9001', 'kaizen', 'operations management', 'stakeholder', 'manufacturing', 'media training', 'etiquette'],
  'Programming & IT': ['it', 'software', 'comptia', 'git', 'database', 'sql', 'oracle', 'networking', 'java', 'c++', 'c#', '.net', 'microsoft', 'power bi', 'tableau', 'rust', 'go', 'golang', 'assembly', 'selenium', 'webdriver', 'postman', 'katalon', 'testng', 'robot framework', 'loadrunner', 'tosca', 'cypress', 'playwright', 'appium', 'jmeter', 'soapui', 'k6', 'qa', 'quality assurance', 'test automation', 'automation testing', 'manual testing', 'software testing', 'api testing', 'performance testing', 'istqb', 'sdet', 'tester', 'test analyst', 'test manager'],
  ...
  'Personal Development': ['personal development', 'productivity', 'communication', 'leadership', 'motivation', 'mindset', 'life coaching', 'neuroscience', 'subconscious', 'brain', 'resume', 'cv', 'interview', 'time management', 'gratitude', 'mindfulness', 'public speaking', 'spirituality', 'manifestation', 'confidence', 'emotional intelligence'],
  ...
  'Finance & Accounting': ['trading', 'forex', 'crypto', 'investment', 'stock', 'financial', 'accounting', 'bookkeeping', 'quickbooks', 'real estate', 'audit', 'auditing', 'internal audit', 'costing', 'cost accounting', 'taxation', 'tax', 'payroll', 'ifrs', 'gaap', 'cpa', 'cfa', 'valuation', 'budgeting'],
  'Health & Fitness': ['health', 'fitness', 'yoga', 'meditation', 'nutrition', 'diet', 'mental health', 'wellness', 'recipes', 'recipe', 'cooking', 'vegetarian', 'vegan', 'keto', 'weight loss', 'wellbeing'],
};
