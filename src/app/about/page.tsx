    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="max-w-3xl mx-auto w-full px-4 py-8 space-y-5">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          make them easy to browse, search and start.
        </p>

        <p className="text-sm text-muted-foreground leading-relaxed">
          Our goal is simple: remove the friction between you and learning. The catalogue is
          refreshed automatically so there is always something new to learn. The experience stays
          fast, clean and easy to use on any device.
        </p>
        ...
        <ul className="text-sm text-muted-foreground leading-relaxed list-disc list-inside space-y-1">
          ...
          <li>Clear course details with what you will learn, requirements and level.</li>
